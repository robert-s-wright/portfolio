...
export const projects: ProjectProps[] = [
  {
    ...
    imgLink: "./assets/Experience/register.PNG",
    description:
  ...
  },
  {
    ...
    description:
      " Uses a React (Javascript) frontend, Node.JS backend, and MongoDB. This was my first project using MongoDB, Node.JS and taught me about using MongoDB drivers in Node.JS to perform CRUD operations. The Node.JS backend follows MVC architechture.",
  ...
  },
  {
    ...
    imgLink: "./assets/Experience/hiltihome.PNG",
    description:
